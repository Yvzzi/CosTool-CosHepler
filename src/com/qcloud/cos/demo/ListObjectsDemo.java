...
public class ListObjectsDemo {
    ...
    public static void listObjectsDemo() {
        ...
        listObjectsRequest.setPrefix("233/144/");
        ...
        System.out.println(Arrays.toString(objectListing.getCommonPrefixes().toArray(new String[objectListing.getCommonPrefixes().size()])));
    ...
    public static void listAllObjects() {
        ...
        COSCredentials cred = new BasicCOSCredentials("AKID3yjvxCoCviP1ZvMAVM9mDa0HPMmuFcEf", "O2ZLoZDgmYCUaViU5YeZED8ubI2fv4Db");
        // 2 设置bucket的区域, COS地域的简称请参照 https://www.qcloud.com/document/product/436/6224
        ClientConfig clientConfig = new ClientConfig(new Region("ap-shenzhen-fsi"));
        // 3 生成cos客户端
        COSClient cosclient = new COSClient(cred, clientConfig);
